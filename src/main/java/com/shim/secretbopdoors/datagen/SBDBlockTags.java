...
public class SBDBlockTags extends BlockTagsProvider {
    ...
    public SBDBlockTags(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider, @Nullable ExistingFileHelper existingFileHelper) {
        super(output, lookupProvider, SecretBOPDoors.MODID, existingFileHelper);
    }
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        tag(SDTags.Blocks.SECRET_WOODEN_PLANK_DOORS)
                .add(SBDBlocks.SECRET_FIR_PLANK_DOOR.get()).add(SBDBlocks.SECRET_REDWOOD_PLANK_DOOR.get())
                ...
                .add(SBDBlocks.SECRET_EMPYREAL_PLANK_DOOR.get()).add(SBDBlocks.SECRET_MAPLE_PLANK_DOOR.get()).add(SBDBlocks.SECRET_PINE_PLANK_DOOR.get());

        tag(SDTags.Blocks.SECRET_LOG_DOORS)
                .add(SBDBlocks.SECRET_FIR_LOG_DOOR.get()).add(SBDBlocks.SECRET_REDWOOD_LOG_DOOR.get())
                ...
                .add(SBDBlocks.SECRET_EMPYREAL_LOG_DOOR.get()).add(SBDBlocks.SECRET_MAPLE_LOG_DOOR.get()).add(SBDBlocks.SECRET_PINE_LOG_DOOR.get())

                .add(SBDBlocks.SECRET_STRIPPED_FIR_LOG_DOOR.get()).add(SBDBlocks.SECRET_STRIPPED_REDWOOD_LOG_DOOR.get())
                ...
                .add(SBDBlocks.SECRET_STRIPPED_EMPYREAL_LOG_DOOR.get()).add(SBDBlocks.SECRET_STRIPPED_MAPLE_LOG_DOOR.get()).add(SBDBlocks.SECRET_STRIPPED_PINE_LOG_DOOR.get())

                .add(SBDBlocks.SECRET_STRIPPED_HORIZONTAL_FIR_LOG_DOOR.get()).add(SBDBlocks.SECRET_STRIPPED_HORIZONTAL_REDWOOD_LOG_DOOR.get())
                ...
                .add(SBDBlocks.SECRET_STRIPPED_HORIZONTAL_EMPYREAL_LOG_DOOR.get()).add(SBDBlocks.SECRET_STRIPPED_HORIZONTAL_MAPLE_LOG_DOOR.get()).add(SBDBlocks.SECRET_STRIPPED_HORIZONTAL_PINE_LOG_DOOR.get())

                .add(SBDBlocks.SECRET_HORIZONTAL_FIR_LOG_DOOR.get()).add(SBDBlocks.SECRET_HORIZONTAL_REDWOOD_LOG_DOOR.get())
                ...
                .add(SBDBlocks.SECRET_HORIZONTAL_EMPYREAL_LOG_DOOR.get()).add(SBDBlocks.SECRET_HORIZONTAL_MAPLE_LOG_DOOR.get()).add(SBDBlocks.SECRET_HORIZONTAL_PINE_LOG_DOOR.get())
        ;
        ...
        tag(SDTags.Blocks.SECRET_WOODEN_PLANK_TRAPDOORS)
                .add(SBDBlocks.SECRET_FIR_PLANK_TRAPDOOR.get()).add(SBDBlocks.SECRET_REDWOOD_PLANK_TRAPDOOR.get())
                ...
                .add(SBDBlocks.SECRET_EMPYREAL_PLANK_TRAPDOOR.get()).add(SBDBlocks.SECRET_MAPLE_PLANK_TRAPDOOR.get()).add(SBDBlocks.SECRET_PINE_PLANK_TRAPDOOR.get());

        tag(SDTags.Blocks.SECRET_LOG_TRAPDOORS)
                .add(SBDBlocks.SECRET_FIR_LOG_TRAPDOOR.get()).add(SBDBlocks.SECRET_REDWOOD_LOG_TRAPDOOR.get())
                ...
                .add(SBDBlocks.SECRET_EMPYREAL_LOG_TRAPDOOR.get()).add(SBDBlocks.SECRET_MAPLE_LOG_TRAPDOOR.get()).add(SBDBlocks.SECRET_PINE_LOG_TRAPDOOR.get())

                .add(SBDBlocks.SECRET_STRIPPED_FIR_LOG_TRAPDOOR.get()).add(SBDBlocks.SECRET_STRIPPED_REDWOOD_LOG_TRAPDOOR.get())
                ...
                .add(SBDBlocks.SECRET_STRIPPED_EMPYREAL_LOG_TRAPDOOR.get()).add(SBDBlocks.SECRET_STRIPPED_MAPLE_LOG_TRAPDOOR.get()).add(SBDBlocks.SECRET_STRIPPED_PINE_LOG_TRAPDOOR.get());
